// src/components/admin/promotions/UsagePanel.tsx
'use client';

import { useMemo, useState } from 'react';
import styles from './promotions.module.scss';
import type { UsageAttemptRow, UsageRedemptionRow } from './types';
import { fmtDateTime, penceToGBP, usageStatusLabel } from './utils';
