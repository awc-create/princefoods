...
import CelebrationSectionsBuilder from '@/components/admin/site/home/celebrations/CelebrationSectionsBuilder';
...
import type { CelebrationSection, HomeSettingsDTO } from '@/types/homeSettings';
...
const DEFAULT_CELEBRATIONS: CelebrationSection[] = [];
...
const DEFAULTS: HomeSettingsDTO = {
  ...
  celebrationSections: DEFAULT_CELEBRATIONS,
  productShowcase: {
    title: 'Featured',
        ...
        if (json?.ok && json.data) {
          setData({
            ...
            promotionBanner: {
              ...
              ...(json.data.promotionBanner ?? {})
            },
            celebrationSections: Array.isArray(json.data.celebrationSections)
              ? json.data.celebrationSections
              : DEFAULTS.celebrationSections
          });
          setDirty(false);
        } else if (json?.error) {
        ...
        <div className={s.panel}>
          <section className={s.section}>
            ...
            <div className={s.sectionBody}>
              ...
              {tab === 'promotions' && (
                <PromotionsForm
                  value={data.promotionBanner}
                  onChange={(v) => setPartial('promotionBanner', v)}
                />
              )}

              {tab === 'celebrations' && (
                <CelebrationSectionsBuilder
                  value={data.celebrationSections}
                  onChange={(v) => setPartial('celebrationSections', v)}
                />
              )}
