...
export default function TermsClient() {
  return (
    <>
      ...
      <p>
        All content on this site is owned or licensed by us and may not be copied without
        permission.
      </p>

      <h2>Liability</h2>
      <p>
        We are not liable for damages arising from use of this site, including errors or service
        interruptions.
      </p>
