  ...
  return (
    <div className={styles.wrapper}>
      ...
      <ul>
        ...
        <li>
          <strong>Preference:</strong> Remember your choices
        </li>
      </ul>

      <h2>How to Manage Cookies</h2>
      <p>
        You can control cookies via your browser settings. Some features may not function properly
        if disabled.
      </p>

      {/* Interactive preferences panel */}
      <Suspense fallback={<p>Loading cookie settings…</p>}>
        <CookiesClient />
      </Suspense>
    </div>
  );
